    ...
    const itinerary = [
        {
            ...
            content: `
                <p><strong>Morning:</strong> Touch down at Denpasar (DPS) via Singapore Airlines SQ944 at 09:50 AM. VIP Concierge assists through dedicated e-VoA lanes.</p>
                ...
                <p><strong>Evening:</strong> Relaxed beachfront walk. Authentic welcome dinner at Queen's Tandoor Nusa Dua.</p>
        ...
        },
        {
            ...
            content: `
                ...
                <p><strong>Afternoon:</strong> Lunch at Zula Vegetarian Paradise. Visit Puja Mandala cultural complex.</p>
                <p><strong>Evening:</strong> Dramatic sea cliffs of Uluwatu Temple. Sunset Kecak Fire Dance performance.</p>
        ...
        },
        {
            ...
            content: `
                <p><strong>Morning:</strong> Early departure to Tegalalang Rice Terraces to beat the heat.</p>
                <p><strong>Afternoon:</strong> Sustainable agricultural estate tour in Tampaksiring (Cacao/Spices). Plant-based lunch at Sayuri Healing Café.</p>
        ...
        },
        {
            ...
            content: `
                <p><strong>Morning:</strong> Base at a privately reserved double-sized luxury gazebo at Waterbom Bali. Lazy river for seniors/toddlers.</p>
        ...
        },
        {
            ...
            content: `
                <p><strong>Morning:</strong> Visit Taman Ayun Temple in Mengwi (flat manicured stone pathways).</p>
                <p><strong>Afternoon:</strong> Customized lunch at Ganesha Ek Sanskriti.</p>
                <p><strong>Evening:</strong> Iconic Tanah Lot Sea Temple. Private farewell dinner on the lawn terraces overlooking the ocean.</p>
        ...
        },
        {
            ...
            content: `
                <p><strong>Morning:</strong> Relaxed breakfast and check-out. Visit Krisna Oleh Oleh premium handicraft center for fixed-price souvenirs.</p>
